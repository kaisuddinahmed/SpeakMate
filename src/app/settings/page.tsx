...
export default function SettingsPage() {
    ...
    useEffect(() => {
        ...
        if (typeof window !== "undefined") {
            ...
            // If goal exists, set home to that goal's dashboard. Otherwise root.
            if (storedGoal && ["ielts", "professional", "general"].includes(storedGoal)) {
                setHomeRoute(`/${storedGoal}`);
            }
        }
    }, []);
            ...
            <div className="w-full max-w-[430px] mx-auto bg-white dark:bg-gray-800 h-screen overflow-hidden flex flex-col">
                ...
                <div className="bg-white dark:bg-gray-800 shadow-sm">
                    <div className="px-4 py-3 flex items-center justify-between">
                        <Logo onClick={() => router.push(homeRoute)} />
                        <button
                ...
                <div className="flex-1 overflow-hidden px-4 py-6 pb-24 overflow-y-auto">
                    ...
                    <div className="space-y-2">
                        ...
                        <button
                            onClick={() => {
                                // Clear user data if needed or just navigate home
                ...
                <div className="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 shadow-lg mt-auto">
                    <div className="px-4 py-3 flex justify-around">
                        ...
                        <NavButton
                            ...
                            label="Dashboard"
                            active={false}
                            onClick={() => router.push(homeRoute === '/' ? '/' : `${homeRoute}/dashboard`)}
                        />
                        <NavButton
                            icon="⚙️"
                            label="Settings"
