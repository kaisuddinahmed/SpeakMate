...
export default function ProfessionalVideosPage() {
  ...
  const videos = [
    { title: "Effective Business Presentations", duration: "12:30", category: "Presentations" },
    { title: "Negotiation Skills Masterclass", duration: "18:45", category: "Negotiation" },
    { title: "Writing Professional Emails", duration: "8:20", category: "Communication" },
    { title: "Acing the Job Interview", duration: "15:10", category: "Interview" },
    { title: "Meeting Etiquette & Participation", duration: "10:55", category: "Meetings" },
    { title: "Networking Like a Pro", duration: "14:30", category: "Networking" },
  ];
      ...
      <div className="w-full max-w-[430px] mx-auto bg-white dark:bg-gray-800 min-h-screen flex flex-col">
        ...
        <div className="sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-lg font-semibold text-gray-800 dark:text-white">Professional Videos</h1>
